...
- <span id="page-8-12"></span>[Daume III2008] Hal Daum ´ e III. 2008. Cross-task ´ knowledge-constrained self training. In *Proceedings of the conference on empirical methods in natural language processing*, pages 680–688. Association for Computational Linguistics.
...
- <span id="page-8-6"></span>[Grac¸a et al.2007] Joao V Grac¸a, Kuzman Ganchev, and Ben Taskar. 2007. Expectation maximization and posterior constraints.
